...
export const mockedProducts: Product[] = [
  {
    ...
    specifications: [
      {
        title: 'Upplösning',
        value: '24.2 Megapixel',
      },
      {
        title: 'Bildsensorstorlek',
        value: 'Fullformat (24x36)',
      },
      {
        title: 'Objektivfattning',
        value: 'Sony E',
      },
      {
        title: 'Sensortyp',
        value: 'CMOS Bakgrundsbelyst',
      },
      {
        title: 'Vikt',
        value: '650 g',
